from lib import damerau_levenshtein, damerau_levenshtein_recurs
...
def test_empty_strings() -> None:
    ...
    assert correct_answer == damerau_levenshtein(str1, str2)[0]
    assert correct_answer == damerau_levenshtein_recurs(str1, str2)[0]
...
def test_with_one_empty() -> None:
    ...
    assert correct_answer == damerau_levenshtein(str1, str2)[0]
    assert correct_answer == damerau_levenshtein(str2, str1)[0]
    assert correct_answer == damerau_levenshtein_recurs(str1, str2)[0]
    assert correct_answer == damerau_levenshtein_recurs(str2, str1)[0]
